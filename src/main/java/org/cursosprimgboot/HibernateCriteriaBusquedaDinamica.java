...
import org.cursosprimgboot.excepcions.ExceptionVacio;
...
public class HibernateCriteriaBusquedaDinamica {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (nombre.isEmpty()){
                throw new ExceptionVacio("Por favor introduce tu nombre");
            }
            if (apellido.isEmpty()){
                throw new ExceptionVacio("Por favor introduce tu apellido");
            }
            if (formaPago.isEmpty()){
                throw new ExceptionVacio("Por favor introduce tu forma de pago");
            }
            System.out.println("-------");
